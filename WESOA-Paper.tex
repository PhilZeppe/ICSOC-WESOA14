...
\hyphenation{crowd-sour-cing middle-ware uni-dir-ection-al inter-mittently}
    ...
    \label{sec:intro:context}
      ...
      A collaboration pattern consists of the following elements:
          ...
          %\begin{LaTeXdescription}
            ...
            %Specification of channels in principle depends on the imposed topology. SSP cannot provide communication functionality between peers, nor between peers and the SSP. Therefore, all the communication should be performed using existing tools (e.g., mail, twitter, Skype). An adapter may be needed when the external tools is used to communicate with SmartSociety Platform. 
