...
\textbf{Paper Organization. }
  ...
  \section{Operational Context of Collective Communication}
    \label{sec:intro:context}
	  ...
	  To describe the communication with a SU, the context also contains a \emph{Communication Context} which defines the context-dependent communication and virtualization channels (e.g., using email, SMS).
      %
